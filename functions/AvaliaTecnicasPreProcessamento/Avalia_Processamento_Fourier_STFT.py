...
from functions.TF.STFT_function import short_time_fourier_transform  # Import the class from the module
...
STFT_instance = short_time_fourier_transform()
...
X = short_time_fourier_transform.STFT(resulting_voltages_withnoise_lowsample['A'], fs, frame_size, hop)
